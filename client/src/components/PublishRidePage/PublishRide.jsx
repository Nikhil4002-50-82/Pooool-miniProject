  ...
  return (
    <div className='p-[8em] h-[auto] flex flex-col'>
        <div className='flex justify-center items-center'>
          <h1 className='text-4xl font-semibold p-4'>Pick-up</h1>
        </div>
        <div className='p-3 flex justify-center items-center'>
          <input className='w-[70%] h-[2.7em] rounded-xl p-3 bg-[#EDEDED]' type="text" placeholder='Enter the full address' name='driverPickUpLoc' value={pickUp} onChange={(event)=>{
